...
global $name, $title, $vaccinationType;
    ...
    <div style="padding: 0 10% 0 10%;">
        ...
        <div class="mb-3">
            <div>
                ...
                <input class="form-control" id="typeId" name="typeId" value="<?= $vaccinationType->typeId ?>" readonly>
            </div>
            <div class="mb-3">
                <label for="typeName" class="form-label">Name</label>
                <input class="form-control" id="typeName" name="typeName" value="<?= $vaccinationType->typeName ?>">
            </div>
